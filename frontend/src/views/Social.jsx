      ...
      <div className="grid grid-cols-12 gap-8">
        <div className="col-span-8 space-y-6">
          <div className="terminal-card bg-bg1/20 border-white/5 p-6">
            ...
            <div className="h-48 w-full bg-white/[0.01] rounded-xl border border-white/5 p-4">
               <p className="text-[10px] font-mono text-white/20 uppercase mb-4 flex items-center gap-2">
          ...
          <div className="terminal-card bg-bg1/20 border-white/5 p-6">
            ...
            <div className="space-y-4">
              {(correlation?.correlations || []).map(item => (
                <div key={item.topic} className="p-4 rounded-xl border border-white/5 bg-white/[0.01] flex items-center justify-between">
            ...
            <div className="space-y-8">
              {(data?.topics || []).slice(4, 9).map(t => (
                <div key={t.topic} className="space-y-3">
                  ...
                  <p className="text-[10px] text-white/40 leading-relaxed italic border-l border-amber/20 pl-3">
