    ...
    <div className="terminal-card bg-bg1/40 border-white/5 h-full">
      ...
      <div className="grid grid-cols-2 gap-4">
        {(venues || []).slice(0, 8).map((venue) => (
          <div
            key={venue.venue}
            className="p-3 rounded-lg bg-white/[0.02] border border-white/5 space-y-2 relative overflow-hidden group"
          >
              ...
              <div className="flex-1 space-y-1">
                ...
                <div className="h-1 bg-white/5 rounded-full overflow-hidden">
                  <motion.div
                    ...
                    className={`h-full ${venue.risk_score > 0.6 ? "bg-red" : "bg-amber"}`}
                  />
                </div>
              </div>
            </div>
